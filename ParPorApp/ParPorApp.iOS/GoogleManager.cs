...
namespace ParPorApp.iOS
{
    ...
    {
        private Action<ParPorApp.Models.GoogleUser, string> _onLoginComplete;
        ...
        public void Login(Action<ParPorApp.Models.GoogleUser, string> OnLoginComplete)
        {
        ...
        public void DidSignIn(SignIn signIn, Google.SignIn.GoogleUser user, NSError error)
        {
            ...
            if (user != null && error == null)
                _onLoginComplete?.Invoke(new ParPorApp.Models.GoogleUser()
                {
